...
class RefundedValidator extends AbstractValidator_1.default {
    constructor(deposit) {
        super();
    ...
    validateStatus() {
        if (this.deposit.status !== Deposit_1.STATUS_BURNED) {
            throw new Errors.CompletedStatusError(this.deposit.id.toValue(), this.deposit.status);
        }
    }
}
exports.default = RefundedValidator;
//# sourceMappingURL=RefundedValidator.js.map