...
let BurnedHandler = class BurnedHandler {
    constructor(repository, internalBlockchain) {
    ...
    async execute(command) {
        ...
        const burnOperations = await this.internalBlockchain.getBurnOperations(deposit._depositRequest.nativeAccount.value);
...
exports.default = BurnedHandler;
//# sourceMappingURL=BurnedHandler.js.map