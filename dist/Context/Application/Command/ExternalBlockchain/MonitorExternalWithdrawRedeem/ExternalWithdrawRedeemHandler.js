...
let ExternalWithdrawRedeemHandler = class ExternalWithdrawRedeemHandler {
    ...
    async execute(command) {
        ...
        await this.rabbitMQ.publish(QueueInterface_1.EXTERNAL_WITHDRAW_CONTRACT_REDEEM, {
            txHash: command.txHash,
            contractId: command.contractId,
        });
    }
};
ExternalWithdrawRedeemHandler = __decorate([
...
exports.default = ExternalWithdrawRedeemHandler;
