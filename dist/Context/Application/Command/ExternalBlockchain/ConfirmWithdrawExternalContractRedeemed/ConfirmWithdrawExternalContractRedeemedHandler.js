...
let ConfirmWithdrawExternalContractRedeemedHandler = class ConfirmWithdrawExternalContractRedeemedHandler {
    constructor(withdrawRepository, blockchainRepository, notifier, setting) {
    ...
    async execute(command) {
        ...
        try {
            ...
            if ((_a = withdraw.externalContract) === null || _a === void 0 ? void 0 : _a.timeLock.value.isBefore(alertDate)) {
        ...
        const ethRequiredBlockConfirmations = parseInt((_b = process.env.ETH_REQUIRED_BLOCK_CONFIRMATIONS) !== null && _b !== void 0 ? _b : "10");
        ...
        withdraw.redeem(command.txHash, contract === null || contract === void 0 ? void 0 : contract.preimage);
        this.withdrawRepository.save(withdraw);
    }
    checkContract(contract, command) {
        if (!contract) {
...
ConfirmWithdrawExternalContractRedeemedHandler = __decorate([
...
exports.default = ConfirmWithdrawExternalContractRedeemedHandler;
