...
const SettingEntity_1 = __importDefault(require("./Entity/SettingEntity"));
let SettingRepository = class SettingRepository {
    constructor(_datasource) {
        this._datasource = _datasource;
    }
    async load(name) {
        const setting = await this._datasource
            .getRepository(SettingEntity_1.default)
